export const site = {
  name: "Cerebritos",
  tagline: "Centro de apoyo educativo",
  logo: "/logo-cerebritos.png",
  instagram: "https://www.instagram.com/cerebritoscentro/",
  whatsapp: "https://wa.me/50769260019",
  ...
  method: [
    { step: "01", title: "Escuchamos", text: "Conocemos las necesidades del niño y de la familia con una mirada cercana." },
    { step: "02", title: "Evaluamos", text: "Observamos su ritmo, habilidades y áreas donde necesita apoyo." },
  ...
  testimonials: [
    ...
    { name: "Papá de estudiante", text: "El apoyo ha sido muy valioso para reforzar áreas importantes y mantener a nuestro hijo motivado." },
    { name: "Familia Cerebritos", text: "Es un espacio cálido y profesional donde se nota el compromiso real con cada proceso." }
  ],
  faqs: [
